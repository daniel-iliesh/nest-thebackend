...
// node_modules/.pnpm/file+packages+themes+jsonresume-theme-community-garden_react-dom@19.2.0_react@19.2.0/node_modules/jsonresume-theme-community-garden/index.js
var index_exports = {};
...
var import_styled_components121 = __ensureStyledComponentsDefault(require("styled-components"));

// node_modules/.pnpm/file+packages+themes+jsonresume-theme-community-garden_react-dom@19.2.0_react@19.2.0/node_modules/jsonresume-theme-community-garden/src/Resume.jsx
var import_react136 = __toESM(require("react"), 1);
var import_styled_components120 = __ensureStyledComponentsDefault(__toESM(__ensureStyledComponentsDefault(require("styled-components")), 1));

// packages/resume-core/src/providers/ThemeProvider.jsx
var import_react = __toESM(require("react"));
var import_styled_components = __ensureStyledComponentsDefault(require("styled-components"));
...
function Link({ href, children, className, ...rest }) {
  ...
  if (!safeHref) {
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className, children });
  }
...
var import_styled_components16 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components17 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components18 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components19 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components20 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components21 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components22 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components23 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components24 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components25 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components26 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components27 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components28 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components29 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components30 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components31 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components32 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components33 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components34 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components35 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components36 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components37 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components38 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components39 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components40 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components41 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components42 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components43 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components44 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components45 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components46 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components47 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components48 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components49 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components50 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components51 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components52 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components53 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components54 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components55 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components56 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components57 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components58 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components59 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components60 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components61 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components62 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components63 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components64 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components65 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components66 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components67 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components68 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components69 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components70 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components71 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components72 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components73 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components74 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components75 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components76 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components77 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components78 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components79 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components80 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components81 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components82 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components83 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components84 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components85 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components86 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components87 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components88 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components89 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components90 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components91 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components92 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components93 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components94 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components95 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components96 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components97 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components98 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components99 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components100 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components101 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components102 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components103 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components104 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components105 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components106 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components107 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components108 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components109 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components110 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components111 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components112 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components113 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components114 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components115 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components116 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components117 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components118 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var import_styled_components119 = __toESM(__ensureStyledComponentsDefault(require("styled-components")));
...
var Label12 = import_styled_components120.default.div`
  ...
  font-style: italic;
`;
var ContactWrapper = import_styled_components120.default.div`
  display: flex;
  justify-content: center;
  flex-wrap: wrap;
  gap: 20px;
  ...
  margin-top: 16px;
`;
var SummarySection = (0, import_styled_components120.default)(Section)`
  margin-bottom: 40px;
  padding: 28px;
  background: #f0fdfa;
  ...
  border-radius: 12px;
`;
var SummaryText = import_styled_components120.default.p`
  margin: 0;
  font-size: 16px;
  line-height: 1.8;
  color: #1e40af;
  ...
  font-style: italic;
`;
var MainSection = (0, import_styled_components120.default)(Section)`
  margin-bottom: 44px;
`;
var MainSectionTitle = (0, import_styled_components120.default)(SectionTitle)`
  font-size: 24px;
  font-weight: 700;
  color: #0c4a6e;
  margin: 0 0 24px 0;
  ...
  min-width: 200px;
`;
var CertificationsGrid = import_styled_components120.default.div`
  display: grid;
  grid-template-columns: repeat(auto-fill, minmax(280px, 1fr));
  gap: 20px;
  margin-bottom: 12px;
`;
var CertCard = import_styled_components120.default.div`
  padding: 20px;
...
`;
var CertName = import_styled_components120.default.h3`
  font-size: 17px;
  font-weight: 700;
  margin: 0 0 8px 0;
  color: #0c4a6e;
`;
var CertIssuer = import_styled_components120.default.div`
  font-size: 14px;
  color: #059669;
  font-weight: 600;
  margin-bottom: 6px;
`;
var CertDate = import_styled_components120.default.div`
  font-size: 13px;
  color: #64748b;
  font-style: italic;
`;
...
var WorkHeader = import_styled_components120.default.div`
  ...
  gap: 10px;
`;
var WorkTitle = import_styled_components120.default.h3`
  font-size: 19px;
  font-weight: 700;
  margin: 0;
  color: #0c4a6e;
`;
var WorkMeta = import_styled_components120.default.div`
  font-size: 14px;
  color: #65a30d;
  font-weight: 600;
`;
var WorkCompany = import_styled_components120.default.div`
  font-size: 16px;
  color: #047857;
  font-weight: 600;
  margin-bottom: 12px;
`;
var WorkDescription = import_styled_components120.default.p`
  font-size: 15.5px;
  line-height: 1.7;
  margin: 14px 0 0 0;
  color: #374151;
`;
var WorkHighlights = import_styled_components120.default.ul`
  margin: 14px 0 0 0;
  padding-left: 24px;
  list-style: none;
...
`;
var VolunteerItem = import_styled_components120.default.div`
  margin-bottom: 32px;
  padding: 24px;
...
`;
var SkillsGrid = import_styled_components120.default.div`
  display: grid;
  grid-template-columns: repeat(auto-fit, minmax(260px, 1fr));
  gap: 18px;
`;
var SkillCard = import_styled_components120.default.div`
  padding: 18px;
  background: #f0f9ff;
  border-left: 4px solid #0ea5e9;
  border-radius: 10px;
`;
var SkillName3 = import_styled_components120.default.h4`
  font-size: 16px;
  font-weight: 700;
  margin: 0 0 10px 0;
  color: #0c4a6e;
`;
var SkillKeywords = import_styled_components120.default.div`
  display: flex;
  flex-wrap: wrap;
  gap: 8px;
`;
var SkillBadge = import_styled_components120.default.span`
  display: inline-block;
  padding: 6px 14px;
  background: #bfdbfe;
  color: #1e40af;
...
`;
var AwardsList = import_styled_components120.default.div`
  display: grid;
  grid-template-columns: repeat(auto-fill, minmax(300px, 1fr));
  gap: 18px;
`;
var AwardCard2 = import_styled_components120.default.div`
  padding: 18px;
...
`;
var PublicationsList = import_styled_components120.default.div`
  display: grid;
  gap: 20px;
`;
var PublicationCard = import_styled_components120.default.div`
  padding: 20px;
  background: #faf5ff;
...
`;
var SimpleList = import_styled_components120.default.div`
  display: grid;
  grid-template-columns: repeat(auto-fit, minmax(250px, 1fr));
  gap: 16px;
`;
var SimpleCard = import_styled_components120.default.div`
  padding: 16px;
  background: #f0fdf4;
...
function Resume({ resume }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(Layout, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(Header12, { children: [
      basics.name && /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(Name10, { children: basics.name }),
      basics.label && /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(Label12, { children: basics.label }),
      /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(ContactWrapper, { children: [
        basics.email && /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(ContactInfo, { type: "email", children: basics.email }),
        basics.phone && /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(ContactInfo, { type: "phone", children: basics.phone }),
        basics.location?.city && basics.location?.region && /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(ContactInfo, { type: "location", children: [
          basics.location.city,
          ", ",
          basics.location.region
        ] }),
        basics.url && /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(ContactInfo, { type: "url", children: /* @__PURE__ */ (0, import_jsx_runtime121.jsx)("a", { href: safeUrl(basics.url), children: basics.url }) }),
        basics.profiles?.map((profile, index) => /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(ContactInfo, { type: "social", children: /* @__PURE__ */ (0, import_jsx_runtime121.jsx)("a", { href: safeUrl(profile.url), children: profile.network }) }, index))
      ] })
    ] }),
    basics.summary && /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(SummarySection, { children: /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(SummaryText, { children: [
      '"',
      basics.summary,
      '"'
    ] }) }),
    certificates && certificates.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(MainSection, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(MainSectionTitle, { children: "Certifications & Diplomas" }),
      /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(CertificationsGrid, { children: certificates.map((cert, index) => /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(CertCard, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(CertName, { children: cert.name }),
        cert.issuer && /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(CertIssuer, { children: [
          "Issued by: ",
          cert.issuer
        ] }),
        cert.date && /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(CertDate, { children: cert.date })
      ] }, index)) })
    ] }),
    volunteer.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(MainSection, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(MainSectionTitle, { children: "Community Involvement" }),
      volunteer.map((vol, index) => /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(VolunteerItem, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(WorkHeader, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(WorkTitle, { children: vol.position }),
          /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(WorkMeta, { children: /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(DateRange, { startDate: vol.startDate, endDate: vol.endDate }) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(WorkCompany, { children: vol.organization }),
        vol.summary && /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(WorkDescription, { children: vol.summary }),
        vol.highlights && vol.highlights.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(WorkHighlights, { children: vol.highlights.map((highlight, i) => /* @__PURE__ */ (0, import_jsx_runtime121.jsx)("li", { children: highlight }, i)) })
      ] }, index))
    ] }),
    work.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(MainSection, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(MainSectionTitle, { children: "Professional Experience" }),
      work.map((job, index) => /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(WorkItem, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(WorkHeader, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(WorkTitle, { children: job.position || job.name }),
          /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(WorkMeta, { children: /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(DateRange, { startDate: job.startDate, endDate: job.endDate }) })
        ] }),
        job.name && /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(WorkCompany, { children: job.name }),
        job.summary && /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(WorkDescription, { children: job.summary }),
        job.highlights && job.highlights.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(WorkHighlights, { children: job.highlights.map((highlight, i) => /* @__PURE__ */ (0, import_jsx_runtime121.jsx)("li", { children: highlight }, i)) })
      ] }, index))
    ] }),
    education.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(MainSection, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(MainSectionTitle, { children: "Education" }),
      education.map((edu, index) => /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(EducationItem, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(WorkHeader, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(WorkTitle, { children: edu.institution }),
          /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(WorkMeta, { children: /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(DateRange, { startDate: edu.startDate, endDate: edu.endDate }) })
        ] }),
        edu.studyType && edu.area && /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(WorkCompany, { children: [
          edu.studyType,
          " in ",
          edu.area
        ] }),
        edu.score && /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(WorkDescription, { children: [
          "GPA: ",
          edu.score
        ] })
      ] }, index))
    ] }),
    skills.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(MainSection, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(MainSectionTitle, { children: "Skills" }),
      /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(SkillsGrid, { children: skills.map((skill, index) => /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(SkillCard, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(SkillName3, { children: skill.name }),
        skill.keywords && skill.keywords.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(SkillKeywords, { children: skill.keywords.map((keyword, i) => /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(SkillBadge, { children: keyword }, i)) })
      ] }, index)) })
    ] }),
    projects.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(MainSection, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(MainSectionTitle, { children: "Projects" }),
      projects.map((project, index) => /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(WorkItem, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(WorkHeader, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(WorkTitle, { children: project.url ? /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(Link, { href: safeUrl(project.url), children: project.name }) : project.name }),
          (project.startDate || project.endDate) && /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(WorkMeta, { children: /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(
            DateRange,
            {
        ...
        project.description && /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(WorkDescription, { children: project.description }),
        project.highlights && project.highlights.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(WorkHighlights, { children: project.highlights.map((highlight, i) => /* @__PURE__ */ (0, import_jsx_runtime121.jsx)("li", { children: highlight }, i)) })
      ] }, index))
    ] }),
    awards.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(MainSection, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(MainSectionTitle, { children: "Awards & Recognition" }),
      /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(AwardsList, { children: awards.map((award, index) => /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(AwardCard2, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime121.jsx)("strong", { children: award.title }),
        award.awarder && /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)("div", { style: { marginTop: "8px", color: "#92400e" }, children: [
          "\u2014 ",
          award.awarder
        ] }),
        award.date && /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(
          "div",
          {
            style: {
              fontSize: "13px",
    ...
    publications.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(MainSection, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(MainSectionTitle, { children: "Publications" }),
      /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(PublicationsList, { children: publications.map((pub, index) => /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(PublicationCard, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime121.jsx)("strong", { children: pub.name }),
        pub.publisher && /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)("div", { style: { marginTop: "8px", color: "#5b21b6" }, children: [
          "\u2014 ",
          pub.publisher
        ] }),
        pub.releaseDate && /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(
          "div",
          {
            style: {
              fontSize: "13px",
    ...
    languages.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(MainSection, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(MainSectionTitle, { children: "Languages" }),
      /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(SimpleList, { children: languages.map((lang, index) => /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(SimpleCard, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime121.jsx)("strong", { children: lang.language }),
        lang.fluency && ` \u2014 ${lang.fluency}`
      ] }, index)) })
    ] }),
    interests.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(MainSection, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(MainSectionTitle, { children: "Interests" }),
      /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(SimpleList, { children: interests.map((interest, index) => /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(SimpleCard, { children: interest.name }, index)) })
    ] }),
    references.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(MainSection, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(MainSectionTitle, { children: "References" }),
      references.map((ref, index) => /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)(WorkItem, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(WorkTitle, { children: ref.name }),
        ref.reference && /* @__PURE__ */ (0, import_jsx_runtime121.jsx)(WorkDescription, { children: ref.reference })
      ] }, index))
    ] })
  ] });
}
...
function render(resume) {
  ...
  const html = (0, import_server.renderToString)(sheet.collectStyles(/* @__PURE__ */ (0, import_jsx_runtime122.jsx)(Resume_default, { resume })));
