...
exports.EducationSection = exports.ProjectsList = exports.WorkExperience = exports.WideSpacing = exports.TightSpacing = exports.Default = void 0;
var react_1 = require("react");
/**
 * StackLayout Stories
 * Vertical stack layout with consistent spacing
 */
var StackLayout_1 = require("./StackLayout");
var meta = {
    title: 'Resume Core/Layouts/StackLayout',
    component: StackLayout_1.StackLayout,
    parameters: {
        layout: 'padded',
    },
    tags: ['autodocs'],
...
exports.WorkExperience = {
    render: function () { return (<StackLayout_1.StackLayout>
      <div style={{
            padding: '1.5rem',
            background: 'white',
    ...
    </StackLayout_1.StackLayout>); },
};
exports.ProjectsList = {
    render: function () { return (<StackLayout_1.StackLayout spacing="1.5rem">
      <div style={{
            padding: '1.5rem',
            background: '#f8f9fa',
...
exports.EducationSection = {
    render: function () { return (<StackLayout_1.StackLayout spacing="1rem">
      <div>
