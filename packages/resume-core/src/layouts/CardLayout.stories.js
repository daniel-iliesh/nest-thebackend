...
exports.SkillCards = exports.ProjectShowcase = exports.CustomGap = exports.NarrowCards = exports.WideCards = exports.Default = void 0;
var react_1 = require("react");
/**
 * CardLayout Stories
 * Responsive grid layout for displaying cards
 */
var CardLayout_1 = require("./CardLayout");
var meta = {
    title: 'Resume Core/Layouts/CardLayout',
    component: CardLayout_1.CardLayout,
    parameters: {
        layout: 'padded',
    },
    tags: ['autodocs'],
...
exports.WideCards = {
    args: {
        minCardWidth: '350px',
        children: (<>
        <ProjectCard title="Project Alpha" description="Large-scale distributed system"/>
        <ProjectCard title="Project Beta" description="Mobile-first web application"/>
        <ProjectCard title="Project Gamma" description="Machine learning pipeline"/>
      </>),
    },
};
exports.NarrowCards = {
...
exports.ProjectShowcase = {
    render: function () { return (<CardLayout_1.CardLayout minCardWidth="280px" gap="1.5rem">
      <div style={{
            padding: '1.5rem',
            background: '#f8f9fa',
    ...
    </CardLayout_1.CardLayout>); },
};
exports.SkillCards = {
    render: function () { return (<CardLayout_1.CardLayout minCardWidth="200px">
      {[
            'JavaScript',
            'React',
            'Node.js',
